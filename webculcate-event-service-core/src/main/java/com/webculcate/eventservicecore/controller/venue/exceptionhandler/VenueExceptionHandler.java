...
public class VenueExceptionHandler {
    ...
    @ExceptionHandler(InvalidVenueUpdateRequestException.class)
    public ResponseEntity<ServiceExceptionResponse> handleInvalidVenueUpdateRequestException(InvalidVenueUpdateRequestException exception) {
        return ResponseEntity.status(BAD_REQUEST)
                .body(new ServiceExceptionResponse(
                        INVALID_VENUE_UPDATE_REQUEST,
                        INVALID_VENUE_UPDATE_REQUEST.getMessage(),
                        List.of(exception.getMessageList()))
                );
    }
